...
MAIN PROC 
 TOP:
CALL INPUT;TAKING HASHMAT'S WARIOR NO
MOV BX,AX;STORING HASHMAT'S WARIOR NO IN BX
CALL INPUT;TAKING HASHMAT'S ENEMY'S WARIOR NO
CMP AX,BX  
JG OK;IF AX > BX JUMP TO OK
XCHG AX,BX;ELSE EXCHANGE VALUE
OK:
SUB AX,BX;AX-BX
CALL OUTPUT
JMP TOP
